...
python3 WKBeam.py bin WKBacca_cases/TCV74304/L1_angular.txt &
python3 WKBeam.py bin WKBacca_cases/TCV74304/L1_abs.txt &
python3 WKBeam.py bin WKBacca_cases/TCV74304/L1_flux3d.txt &
python3 WKBeam.py bin WKBacca_cases/TCV74304/L1_XZ.txt &
python3 WKBeam.py bin WKBacca_cases/TCV74304/L1_1D_at_harm.txt &
