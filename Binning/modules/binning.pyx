...
cpdef int binning(np.ndarray [double, ndim=3] data_sim,
                  ...
                  double dir1min, double dir1max, 
                  double dir2min, double dir2max,
                  double dir3min, double dir3max,
                  double dir4min, double dir4max,
                  int nmbrdir1, int nmbrdir2, int nmbrdir3, int nmbrdir4,
